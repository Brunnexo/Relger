...
public class DefinirTempo extends JFrame {
	...
	public void registrar()
	{
		...
		else
		{
			if (att.checaEntrada(valorNum))
			{
				if (att.horaExtra())
				{
					switch (JOptionPane.showOptionDialog(this.painel, "Deseja registrar " + this.valorNum + " " + plural(this.valorNum) + " de tempo extra?", "Confirmação", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, botoes, botoes[1]))
					{
					case 0:
				...
				{
					switch (JOptionPane.showOptionDialog(this.painel, "Deseja registrar " + this.valorNum + " " + plural(this.valorNum) + "?", "Confirmação", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, botoes, botoes[1]))
					{
					case 0:
						switch (Relatorios.registrar(att, valorNum))
						{
	...
	{
		switch (JOptionPane.showOptionDialog(this.painel, "Deseja continuar?", "Continuar", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, botoes, botoes[1]))
		{
		case 0:
			return true;
		default:

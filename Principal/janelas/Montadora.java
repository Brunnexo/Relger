...
public class Montadora extends JFrame
{
	...
	Montadora selMont = this;

	public Montadora(DescricoesSub pai)
	{
		//Janela
		...
		//GENERAL MOTORS
		gm.setIcon(new ImageIcon(Montadora.class.getResource("/logos/generalmotors.png")));
		gm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				att.setMontadora(1);

				Projeto selProj = new Projeto(selMont);
		...
		//VOLKSWAGEN
		vw.setIcon(new ImageIcon(Montadora.class.getResource("/logos/vw.png")));
		vw.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				att.setMontadora(2);

				Projeto menu = new Projeto(selMont);
		...
		ford.setIcon(new ImageIcon(Montadora.class.getResource("/logos/ford.png")));
		...
		fca.setIcon(new ImageIcon(Montadora.class.getResource("/logos/fca.png")));
		...
		renault.setIcon(new ImageIcon(Montadora.class.getResource("/logos/renault.png")));
		...
		honda.setIcon(new ImageIcon(Montadora.class.getResource("/logos/honda.png")));
		...
		nissan.setIcon(new ImageIcon(Montadora.class.getResource("/logos/nissan.png")));
		...
		toyota.setIcon(new ImageIcon(Montadora.class.getResource("/logos/toyota.png")));
		...
		hyundai.setIcon(new ImageIcon(Montadora.class.getResource("/logos/hyundai.png")));
		...
		mercedes.setIcon(new ImageIcon(Montadora.class.getResource("/logos/mercedes.png")));
		...
		psa.setIcon(new ImageIcon(Montadora.class.getResource("/logos/psa.png")));
		...
		man.setIcon(new ImageIcon(Montadora.class.getResource("/logos/man.png")));
		...
		outros.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Projeto menu = new Projeto(selMont, outros);
				menu.setVisible(true);
			}
		});

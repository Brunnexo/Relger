...
import extensores.JFrameEx;
import janelas.GerarRelatorio;
import janelas.Identificacao;
...
public class Inicio extends JFrameEx {
	...
	public JButton gerenciarFunc;
	public JButton atualizarProj;
	public JButton iniciar;
	public JButton gerar;
	...
	public Inicio() {
		...
		//Versão do Software
		JLabel versao = new JLabel(Executar.VERSAO);
		painel.add(versao);

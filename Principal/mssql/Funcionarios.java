...
public class Funcionarios {
	...
	public static ResultSet nomeAdministrativo()
	{
		try {
			String sql = "SELECT [F].[NOME] FROM [dbo].[SENHAS] AS [S] INNER JOIN [dbo].[FUNCIONARIOS] AS [F] ON [S].[CRACHA] = [F].[CRACHA]";
			PreparedStatement st = Conn.connection.prepareStatement(sql, SQLServerResultSet.TYPE_SCROLL_SENSITIVE, SQLServerResultSet.CONCUR_READ_ONLY);
